...
class AboutClassMethods < Neo::Koan
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods
    ...
    # The wag method only belongs to the fido instance of the Dog
    # class. The rover instance does not have it.
  ...
  # Wow! You could actually do that?! Since classes are objects, you can define singleton methods on them too!
  def Dog2.wag
    :class_level_wag
  end
  ...
  # I personally prefer the first way; it's much clearer that way. I always separate my class and instance methods, so differentiation is not a problem. I might use the second way if I had to define just one class method and wanted a novel way to do it.
  # ------------------------------------------------------------------
