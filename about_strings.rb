...
class AboutStrings < Neo::Koan
  ...
  # Note:
  #   So, either use \"Don't\" within "YourString";
  #   or use "Don\'t" within 'YourString'.
...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Answer:
    #   << alters the original string rather than creating a new one. Because in Ruby a += b is syntactic shorthand for a = a + b (the same goes for the other <op>= operators) which is an assignment. On the other hand << is an alias of concat() which alters the receiver in-place. This results in efficient memory usage when dealing with large scale string manipulation.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    #   Answer:
    #     Kind of. String element being accessed like an array.
  end
